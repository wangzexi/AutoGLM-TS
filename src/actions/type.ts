...
export const type: Action = {
	...
	handler: async (params, ctx) => {
		...
		await delay(500);
		await adb.typeText(text, ctx.deviceId);
		await delay(1000);
...
export const typeName: Action = {
	name: "Type_Name",
	description: "Type_Name是输入人名的操作，基本功能同Type。",
	usage: 'do(action="Type_Name", text="xxx")',
